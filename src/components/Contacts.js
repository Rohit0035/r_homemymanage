...
class Contacts extends Component {
  ...
  render() {
    ...
    return (
      <section className="contact_info_area sec_pad bg_color rht-padd">
            ...
            <div className="col-lg-3">
              ...
              <div className="contact_info_item">
                ...
                <p className="f_400 f_size_15">
                  ...
                  <a href="mailto:Mymanager@gmail.com">Mymanager@gmail.com</a>
                </p>
              </div>
            </div>
...
//                                 <p className="f_400 f_size_15"><span className="f_400 t_color3">Email:</span> <a href="mailto:Mymanager@gmail.com">Mymanager@gmail.com</a></p>
//                             </div>
//                         </div>
//                         <div className="contact_form col-lg-9">
