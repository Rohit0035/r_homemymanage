      ...
      items: [
        {
          ...
          description:
            "Loo car boot bodge smashing I up the duff horse play give us a bell, William bugger all mate happy days mush at public school tosser victoria sponge, say lurgy hunky-dory twit hotpot gutted mate.",
          name: "Lance Bogrol,",
      ...
      <section className="erp_testimonial_area sec_pad">
        <div className="container">
          <Sectitle
            ...
            Title="What our customers say about Mymanager ERP"
          />
          <div className="row">
            ...
            <Slider
              ref={(c) => (this.slider = c)}
              className="erp_testimonial_info"
              {...settings}
            >
              {this.state.items.map((item) => (
                <div className="item" key={item.id}>
                  <div className="erp_testimonial_item">
                    ...
                    <div className="media">
                      <img
                        src={require("../../img/erp-home/" + item.image)}
                        alt=""
                      />
