        ...
        <div className="row">
          <div className="col-lg-8 blog_sidebar_left">
            <div className="blog_single mb_50">
              <img
                className="img-fluid"
                src={require("../../img/blog-grid/blog_single.png")}
                alt=""
              />
              <div className="blog_content">
                ...
                <div className="media post_author mt_60">
                  ...
                  <div className="media-body">
                    ...
                    <p>
                      Tinkety tonk old fruit Harry gormless morish Jeffrey what
                      a load of rubbish burke what a plonker hunky-dory cor
                      blimey guvnor.!
                    </p>
                  </div>
                </div>
                    ...
                    <div className="media post_author comment-content">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          ...
                          victoria sponge Charles tinkety tonk old fruit argy.!
                        </p>
                      </div>
                    </div>
                  </li>
