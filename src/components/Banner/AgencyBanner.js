                  ...
                  {BannerData.AgencyText.map((Agency) => {
                    return (
                      <React.Fragment key={Agency.id}>
                        <h2 className='f_700 t_color3 mb_40 wow fadeInLeft' data-wow-delay='0.3s'>
                          {Agency.btitle}
                        </h2>
                        <p className='f_400 l_height28 wow fadeInLeft mt-2' data-wow-delay='0.4s'>
                          {Agency.description}
                        </p>
                      </React.Fragment>
                    )
              ...
              return (
                <Reveal key={item.id} effect='fadeInLeft' duration={1500}>
                  <div className='p_logo_item'>
                    <a href='/#'>
                      <img src={require("../../img/home3/" + item.image)} alt='' />
                    </a>
                  </div>
                </Reveal>
              )
